 ...
 * @generated
 */
public class PositionLocalServiceClp implements PositionLocalService {
    ...
    public ru.isands.model.Position addPosition(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(position) });
        } catch (Throwable t) {
        ...
        return (ru.isands.model.Position) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<ru.isands.model.Position> getPositions(int start,
        ...
        return (java.util.List<ru.isands.model.Position>) ClpSerializer.translateOutput(returnObj);
    }
