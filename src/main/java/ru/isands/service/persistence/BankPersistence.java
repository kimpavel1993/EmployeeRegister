...
public interface BankPersistence extends BasePersistence<Bank> {
    ...
    * @param bank the bank
    */
    public void cacheResult(ru.isands.model.Bank bank);
    ...
    */
    public void cacheResult(java.util.List<ru.isands.model.Bank> banks);
    ...
    * @return the new bank
    */
    public ru.isands.model.Bank create(long bankId);
    ...
    */
    public ru.isands.model.Bank remove(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.NoSuchBankException;

    public ru.isands.model.Bank updateImpl(ru.isands.model.Bank bank)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public ru.isands.model.Bank findByPrimaryKey(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.NoSuchBankException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public ru.isands.model.Bank fetchByPrimaryKey(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<ru.isands.model.Bank> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<ru.isands.model.Bank> findAll(int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException;
