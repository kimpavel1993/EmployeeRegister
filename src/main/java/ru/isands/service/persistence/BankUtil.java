...
public class BankUtil {
    ...
    * @param bank the bank
    */
    public static void cacheResult(ru.isands.model.Bank bank) {
    ...
    */
    public static void cacheResult(java.util.List<ru.isands.model.Bank> banks) {
    ...
    * @return the new bank
    */
    public static ru.isands.model.Bank create(long bankId) {
    ...
    */
    public static ru.isands.model.Bank remove(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.NoSuchBankException {
        return getPersistence().remove(bankId);
    }

    public static ru.isands.model.Bank updateImpl(ru.isands.model.Bank bank)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.model.Bank findByPrimaryKey(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.NoSuchBankException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.model.Bank fetchByPrimaryKey(long bankId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.model.Bank> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.model.Bank> findAll(int start,
    ...
    */
    ...
    public static BankPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (BankPersistence) PortletBeanLocatorUtil.locate(ru.isands.service.ClpSerializer.getServletContextName(),
